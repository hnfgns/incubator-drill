...
public class TestHBaseTableProvider extends BaseHBaseTest {
  ...
  public void testTableProvider() throws StoreException {
    ...
    PersistentStore<String> hbaseStore = provider.getStore(PersistentStoreConfig.newJacksonBuilder(lp.getMapper(), String.class).name("hbase").build());
    hbaseStore.put("", "v0");
    ...
    PersistentStore<String> hbaseTestStore = provider.getStore(PersistentStoreConfig.newJacksonBuilder(lp.getMapper(), String.class).name("hbase.test").build());
